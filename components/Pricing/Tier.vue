  ...
  <div class="shadow-md ">
    <div class="p-6 bg-yellow-200">
      ...
      <p class="mt-4 text-center">
        <span class="text-4xl font-extrabold font-display text-gray-800">${{ selected === 'monthly' ? tier.priceMonthly : tier.priceYearly }}</span>
        {{ ' ' }}
    ...
    <div class="pt-6 pb-8 px-6">
      ...
      <ul role="list" class="mt-6 space-y-4">
        <li v-for="feature in tier.includedFeatures" :key="feature" class="flex space-x-3">
          <CheckIcon class="flex-shrink-0 h-5 w-5 text-green-600" aria-hidden="true" />
