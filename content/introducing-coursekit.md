...
First, a little bit about me. I’m [Anthony Gore](https://twitter.com/anthonygore) and I’ve been a web developer for around 10 years.
...
While I was able to get the features and design was looking for, it was a crazy amount of work, most of which was spent on backend stuff that I really didn’t need to customize.

This got me thinking - what if took what I’d made and spun it off into a product to save other developers from having to repeat this same work? And so CourseKit was conceived.
...
Instead, your content is available from a secure HTTP service. This architecture allows you to create a custom frontend and so frees you from the prosaic design and UX of the main platforms.
...
The other major difference between CourseKit and other platforms is that CourseKit is not a “business in a box” i.e. it is not bloated with features like video hosting, emails, payment gateways, etc.
